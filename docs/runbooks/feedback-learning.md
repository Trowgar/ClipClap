...
## Retired V4 experiment

V4 and its outcome commands were removed on 2026-09-08 after real-source checks
showed no additional clips. The clip quality gate above remains active.
Historical job/feedback attribution and private evidence are retained for audit.
