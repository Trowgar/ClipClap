...
ALTER TABLE "support_messages" ADD COLUMN "deliveryClaim" TEXT;
...
ALTER TABLE "support_messages" ADD COLUMN "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
