      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-2">
          ...
          <p className="max-w-xl text-sm leading-6 text-muted-foreground">
            {starter.minutesPerPeriod} minutes every week · sources up to{" "}
            {starter.maxSourceDurationMinutes / 60} hours · {starter.storageClips} clips kept for{" "}
            {starter.retentionDays} days · cancel anytime.
          </p>
        </div>
