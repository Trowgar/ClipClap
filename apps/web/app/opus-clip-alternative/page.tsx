...
const BOT = "https://t.me/clipclapio_bot?start=src_cmp_opus";
    ...
    <div className="min-h-screen bg-black text-neutral-200">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-neutral-300">
          ...
          <p>
            The third is that the free 40 minutes produce clips with no watermark, so what
        ...
        <section className="mt-12 rounded-xl border border-white/10 p-6">
          <p className="text-[15px] text-neutral-300">
            Try it on your own footage before deciding - 40 minutes of source video, no
            card, no watermark.
          </p>
