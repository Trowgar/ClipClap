...
export const metadata: Metadata = {
  ...
  description:
    "Turn a long stream, podcast or VOD into vertical clips with burned-in subtitles. First 60 minutes of source video are free, no card needed; paid plans start at $3 a week for 75 minutes. Works in Telegram or in the browser.",
              ...
              offers: [
                {
                  ...
                  priceCurrency: "USD",
                  description:
                    "60 minutes of source video, one-time, no card required.",
                },
                {
                  "@type": "Offer",
                  name: "Starter weekly",
