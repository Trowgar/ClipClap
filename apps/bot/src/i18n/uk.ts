...
const ukFailure: Record<JobErrorCode, string> = {
  UNSUPPORTED_INPUT:
    "Не вдалося прочитати цей файл як відео. Можливо, він пошкоджений, завантажився не повністю або не містить відеодоріжки. Перевір, що оригінальний файл відтворюється до кінця, і надішли справний відеофайл. Хвилини не списані.",
...
const uk: Dict = {
  ...
  welcomeNeedsPlan:
    "Надішли відео, і я зроблю кліпи. Новий акаунт отримує один безкоштовний запуск: без картки, до 40 хвилин відео.",
  ...
  freeExhausted: (remainingMinutes, lifetimeMinutes, planMinutes, planPriceEur, offer) =>
    `Безкоштовних хвилин на це не вистачить - лишилося ${remainingMinutes} із ${lifetimeMinutes}. Усе, що я вже встиг нарізати, залишається твоїм.\n\n${offer ?? `Щоб продовжити: Starter коштує €${planPriceEur} на тиждень і дає ${planMinutes} хвилин відео, джерела до 3 годин та 20 кліпів, які зберігаються 7 днів.`}`,
  ...
  plansText:
    ...
    "🚀 <b>Plus</b> - €29/міс\n   • 1000 хв/міс\n   • 150 кліпів\n   • зберігання 30 днів\n\n" +
    "👑 <b>Max</b> - €89/міс\n   • 3500 хв/міс\n   • 1000 кліпів\n   • зберігання 90 днів\n   • ⚡ пріоритетна черга\n\n" +
    "Джерела до 180 хвилин; залишку хвилин має вистачати на все відео. Starter на тиждень включає 75 хвилин: для відео довше 75 хвилин обери місячний тариф (270 хвилин) або надішли коротший фрагмент.\n\n" +
    "Обери тариф нижче 👇",
  ...
  urlAccessFailed:
    "Не вдалося отримати відео за цим посиланням. Завантаж відеофайл сюди напряму.",
  urlYouTubeUnavailable:
    "YouTube блокує доступ до відео. Завантаж відеофайл сюди напряму.",
  purchaseResubmit: "Після підтвердження оплати надішли відео ще раз, щоб почати обробку.",
