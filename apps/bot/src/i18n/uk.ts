...
const uk: Dict = {
  ...
  newAccountCreated:
    "Акаунт створено. Надсилай відео просто зараз: перше безкоштовне й без картки.\n\nДо 60 хвилин. Якщо кліпів не вийде, це не зарахується як безкоштовний запуск.",
