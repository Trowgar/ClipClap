...
const ru: Dict = {
  ...
  urlYouTubeUnavailable:
    "Ссылки на YouTube сейчас не работают - блокирует нас YouTube, а не твоя ссылка, поэтому другая ссылка с YouTube тоже не поможет. Блокировка приходит и уходит: пришли эту же ссылку ещё раз чуть позже, загрузи видеофайл сюда напрямую или дай ссылку с TikTok или Twitch.",
