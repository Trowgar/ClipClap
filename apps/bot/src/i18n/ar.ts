...
const ar: Dict = {
  ...
  sourceTooShort:
    "هذا الفيديو أقصر من دقيقة. أنا أقتطع المقاطع من كلام طويل - بثوث، بودكاست، مقابلات، محاضرات - وهنا لا يوجد ما يُقتطع بعد. أرسل شيئًا مدته دقيقة على الأقل؛ من عشر دقائق فأكثر تكون النتيجة الأفضل.",
  shortSourceNotice:
    "تنبيه: هذا الفيديو أقصر من خمس دقائق. المصادر القصيرة عادةً تعطي مقطعًا أو مقطعين أو لا شيء - من عشر دقائق فأكثر أعمل بأفضل شكل.",
  duplicateActive:
    "أنا أعمل على هذا الفيديو نفسه الآن - سأراسلك فور جاهزيته. لا داعي لإرساله مرة أخرى.",
  duplicateDone: (clipCount) =>
    `سبق أن أرسلت لي هذا الفيديو - ${clipCount === 1 ? "إليك المقطع الذي" : `إليك المقاطع الـ${clipCount} التي`} صنعتها منه، دون استهلاك دقائق.`,
