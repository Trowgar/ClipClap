...
const ar: Dict = {
  ...
  urlYouTubeUnavailable:
    "روابط يوتيوب لا تعمل حاليًا - يوتيوب يحجبنا نحن، لا أنت، لذلك لن يفيد رابط يوتيوب آخر. ارفع ملف الفيديو هنا بدلًا من ذلك، أو أرسل رابطًا من تيك توك أو تويتش.",
